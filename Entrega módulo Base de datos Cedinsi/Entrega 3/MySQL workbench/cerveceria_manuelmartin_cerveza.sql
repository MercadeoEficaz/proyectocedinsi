...
CREATE TABLE `cerveza` (
  ...
  CONSTRAINT `id_categoria` FOREIGN KEY (`idcerveza`) REFERENCES `categoria` (`idcategoria`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Esta es la tabla llamada cerveza';
...
INSERT INTO `cerveza` VALUES (1,'Lagers','Cerveza Lagers'),(2,'Ales','Cerveza Ales');
